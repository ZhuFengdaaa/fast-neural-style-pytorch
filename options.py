...
class Options():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--content_layers', type=str, default='relu2_2', help='content_layers')
        self.parser.add_argument('--style_layers', type=str, default='relu1_2,relu2_2,relu3_3,relu4_3',
                                 help='style_layers')
